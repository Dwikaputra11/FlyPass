...
import cthree.admin.flypass.adapter.AirportSearchAdapter
import cthree.admin.flypass.databinding.FragmentSearchAirportBinding
...
class SearchAirportFragment : Fragment() {
    ...
    lateinit var binding : FragmentSearchAirportBinding
